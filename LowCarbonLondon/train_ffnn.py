...
os.makedirs(f'checkpoints/ffnn/block{block_id}', exist_ok=True)
os.makedirs(f'checkpoints/ffnn/block{block_id}/node{target_node}', exist_ok=True)

os.makedirs('results', exist_ok=True)
os.makedirs(f'results/block{block_id}', exist_ok=True)
os.makedirs(f'results/block{block_id}/ffnn', exist_ok=True)
#################################
...
for e in range(epochs):
    ...
    if avg_val_loss < best_val_loss:
        ...
        torch.save(model.state_dict(), f'checkpoints/ffnn/block{block_id}/node{target_node}/london_model.pkl')

        with open(f'results/block{block_id}/ffnn/block{block_id}_node{target_node}.txt', 'w') as handle:
