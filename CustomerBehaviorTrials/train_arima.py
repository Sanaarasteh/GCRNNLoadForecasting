...
###################################
# Configuring the necessary directories
os.makedirs('results', exist_ok=True)
os.makedirs(f'results/group_{group_id}/cluster_{cluster_id}', exist_ok=True)
os.makedirs(f'results/group_{group_id}/cluster_{cluster_id}/arima', exist_ok=True)
...
with open(f'results/group_{group_id}/cluster_{cluster_id}/arima/node_{target_node}.txt', 'w') as handle:
