...
os.makedirs(f'checkpoints/lstm/group_{group_id}', exist_ok=True)
os.makedirs(f'checkpoints/lstm/group_{group_id}/cluster_{cluster_id}', exist_ok=True)
os.makedirs(f'checkpoints/lstm/group_{group_id}/cluster_{cluster_id}/node_{target_node}', exist_ok=True)

os.makedirs('results', exist_ok=True)
os.makedirs(f'results/group_{group_id}/cluster_{cluster_id}', exist_ok=True)
os.makedirs(f'results/group_{group_id}/cluster_{cluster_id}/lstm', exist_ok=True)
...
for e in range(epochs):
    ...
    if avg_val_loss < best_val_loss:
        ...
        torch.save(model.state_dict(),
                   f'checkpoints/lstm/group_{group_id}/cluster_{cluster_id}/node_{target_node}/cer_model.pkl')

        with open(f'results/group_{group_id}/cluster_{cluster_id}/lstm/node_{target_node}.txt', 'w') as handle:
